...
CREATE TABLE `dim_municipios` (
  ...
  `ind_fronteira` varchar(45) DEFAULT NULL,
  `ind_capital` varchar(45) DEFAULT NULL,
  `ind_semi_arido` varchar(45) DEFAULT NULL,
  `alt_municipio` int(11) DEFAULT NULL,
  `are_municipio` double(18,4) DEFAULT NULL,
  `num_versao` int(11) DEFAULT NULL,
  `dat_ini_versao` date DEFAULT NULL,
  `dat_fim_versao` date DEFAULT NULL,
  PRIMARY KEY (`key_municipio`)
) ENGINE=InnoDB AUTO_INCREMENT=5633 DEFAULT CHARSET=utf8 COMMENT='Municipios';
...
-- Dump completed on 2015-04-25  9:42:36
